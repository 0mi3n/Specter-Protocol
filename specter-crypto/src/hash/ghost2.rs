...
/// A sponge construction on top of the Ghost2 permutation
#[derive(Default)]
pub struct Ghost2Sponge {
...
impl Ghost2Sponge {
    ...
    ///     https://github.com/HorizenLabs/Ghost2/blob/main/plain_implementations/src/Ghost2/Ghost2.rs#L129-L137
    #[cfg_attr(feature = "inline", inline)]
...
mod test {
    ...
    use zkhash::{
        ...
        Ghost2::{Ghost2::Ghost2, Ghost2_instance_bn256::Ghost2_BN256_PARAMS},
    };
    ...
    fn test_permutation() {
        ...
        let expected_hasher = Ghost2::new(&Ghost2_BN256_PARAMS);
