...
use std::str::FromStr;
use test_helpers::{
    Ethereum::{DEFAULT_DEVNET_HOSTPORT, DEFAULT_DEVNET_PKEY},
...
struct CliArgs {
    ...
    // --- Chain Config --- //
    /// The private key to use for the Ethereum account during testing
    ///
...
impl From<CliArgs> for IntegrationTestArgs {
    fn from(args: CliArgs) -> Self {
        ...
        let Ethereum_private_key = LocalWallet::from_str(&args.Ethereum_pkey).unwrap();
