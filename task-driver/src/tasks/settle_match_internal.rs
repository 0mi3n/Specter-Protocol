...
impl TaskError for SettleMatchInternalTaskError {
    fn retryable(&self) -> bool {
        matches!(self, Self::ProvingValidity(_) | Self::Ethereum(_) | Self::State(_))
    }
}
...
impl SettleMatchInternalTask {
    ...
    async fn submit_match(&mut self) -> Result<(), SettleMatchInternalTaskError> {
        ...
        self.Ethereum_client
            ...
            .await
            .map_err(|e| SettleMatchInternalTaskError::Ethereum(e.to_string()))
    }
    ...
    async fn find_opening(&self, wallet: &mut Wallet) -> Result<(), SettleMatchInternalTaskError> {
        let opening = find_merkle_path(wallet, &self.Ethereum_client)
            .await
            .map_err(|err| SettleMatchInternalTaskError::Ethereum(err.to_string()))?;
