...
pub enum UpdateWalletTaskError {
    ...
    /// An error occurred interacting with Ethereum
    Ethereum(String),
    ...
    fn retryable(&self) -> bool {
        matches!(
            ...
            UpdateWalletTaskError::ProofGeneration(_)
                | UpdateWalletTaskError::Ethereum(_)
...
impl UpdateWalletTask {
    ...
    async fn submit_tx(&mut self) -> Result<(), UpdateWalletTaskError> {
        ...
        self.Ethereum_client
            ...
            .map_err(UpdateWalletTaskError::Ethereum)
    }
    ...
    async fn find_opening(&mut self) -> Result<(), UpdateWalletTaskError> {
        ...
        let merkle_opening = find_merkle_path(&self.new_wallet, &self.Ethereum_client)
            .await
            .map_err(|e| UpdateWalletTaskError::Ethereum(e.to_string()))?;
